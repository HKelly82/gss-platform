    ...
    <article className="relative min-h-screen w-full bg-navy-deep text-white">
      <header className="border-b border-white/10">
        <div className="mx-auto flex max-w-scenario items-center justify-between px-6 py-4">
          <Link
            href={backHref}
            className="inline-flex items-center gap-2 rounded-control text-eyebrow uppercase tracking-[0.08em] text-white/70 hover:text-white motion-reduce:transition-none"
          >
            <span aria-hidden="true">←</span> Back to {tier} overview
          </Link>
          <span className="font-mono text-mono-meta uppercase tracking-[0.08em] text-white/60">
            Component 1 of 4
          </span>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-scenario px-6 py-12 sm:py-16">
        ...
        <p className="mt-4 font-mono text-mono-meta uppercase tracking-[0.08em] text-white/60">
          {tierName}
        </p>
        ...
        <div className="mt-12">
          <Link
            href={guidedHref}
            className="inline-flex items-center gap-2 rounded-card bg-yellow px-5 py-3 font-sans text-body font-semibold text-navy hover:bg-yellow/90 focus-visible:shadow-[0_0_0_3px_white] motion-reduce:transition-none"
          >
